...
class SX126X:
    ...
    def __del__(self):
        ...
        del self._ldro
        del self._crcType
        del self._preambleLength
        del self._tcxoDelay
        del self._headerType
        del self._implicitLen
        del self._txIq
        del self._rxIq
        del self._invertIQ
        del self._ldroAuto
        ...
        del self._rxBw
        del self._rxBwKhz
        del self._pulseShape
        del self._crcTypeFSK
        del self._preambleLengthFSK
        del self._addrComp
        del self._syncWordLength
        del self._whitening
        del self._packetType
        del self._dataRate
        del self._packetLength
        del self._preambleDetectorLength
